...
<body>
    ...
    <header class="w-100">
        <nav class="d-flex flex-row">
            <img src="https://res.cloudinary.com/billmal/image/upload/v1594983019/left_cloud_greenish_1_kosoi5.png" alt="left cloud greenish" style="width: 75%"
                class="img-fluid">
            <h2 id="logo" class="pl-n5 ml-n5"> <img src="https://res.cloudinary.com/billmal/image/upload/v1594982989/book-open_lcw9gr.svg" alt="" class="mr-2"> Stud-y</h2>
        </nav>
    </header>
    ...
    <main>
        ...
        <section class="container">
            <div class="d-flex flex-md-row flex-column justify-content-center">
                <div class="container pt-5 align-items-center text-small-screen" id="mp-lt"
                    ...
                    <a href="#text-direct" class="btn text-capitalize py-sm-3 px-sm-5" id="see-how-it-works-btn" type="submit">see how it
                        works <img src="https://res.cloudinary.com/billmal/image/upload/v1594983032/rightarrow_fodqi3.svg" class="pl-2" alt="right-arrow">
                    </a>
                </div>
                <div uk-scrollspy="cls: uk-animation-slide-left; repeat: false" class="img-small-screen">
                    <img src="https://res.cloudinary.com/billmal/image/upload/v1594982992/coming-soon_vnmkoj.png" alt="coming soon" srcset="" class="img-fluid">
                </div>
            </div>
        </section>
            ...
            <div class="d-flex flex-md-row flex-column justify-content-center pt-3"
                ...
                <div class="col-md-4 justify-content-center text-center">
                    <div class="mt-4 mt-md-1">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594984359/step-1_enormt.png" alt="">
                    </div>
                    <div>
                ...
                <div class="col-md-4 justify-content-center text-center" uk-scrollspy-class="uk-animation-slide-top">
                    <div class="mt-4 mt-md-1">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594984353/step-2_ijbbv8.png" alt="">
                    </div>
                    <div>
                ...
                <div class="col-md-4 justify-content-center text-center">
                    <div class="mt-4 mt-md-1">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594984345/step-3_wgxmdt.png" alt="">
                    </div>
                    <div>
            ...
            <div class="container">
                <div class="d-flex flex-md-row flex-column justify-content-center row text-small-screen"
                    ...
                    <div class="col-md-6 mt-md-0 mt-5 img-small-screen"
                        ...
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594984311/study-phone_rddljy.png" alt="phone with study">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="container px-3 justify-content-center" id="mb-6"
            ...
            <div class="image-grid-box" uk-lightbox="animation: slide">
                <div>
                    <a class="uk-inline" href="https://res.cloudinary.com/billmal/image/upload/v1594983001/design-1_dy4g1o.png" >
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594983001/design-1_dy4g1o.png" alt="design for product, image 1">
                    </a>
                </div>
                <div>
                    <a class="uk-inline" href="https://res.cloudinary.com/billmal/image/upload/v1594983062/design-2_cohz9x.png">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594983062/design-2_cohz9x.png" alt="">
                    </a>
                </div>
                <div>
                    <a class="uk-inline" href="https://res.cloudinary.com/billmal/image/upload/v1594983024/design-3_aeiodo.png">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594983024/design-3_aeiodo.png" alt="">
                    </a>
                </div>
                <div>
                    <a class="uk-inline" href="https://res.cloudinary.com/billmal/image/upload/v1594984317/design-4_ucyhui.png">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594984317/design-4_ucyhui.png" alt="">
                    </a>
                </div>
                <div>
                    <a class="uk-inline" href="https://res.cloudinary.com/billmal/image/upload/v1594984346/design-5_yidsjn.png">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594984346/design-5_yidsjn.png" alt="">
                    </a>
                </div>
                <div>
                    <a class="uk-inline" href="https://res.cloudinary.com/billmal/image/upload/v1594983013/design-6_wzgsey.png">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594983013/design-6_wzgsey.png" alt="">
                    </a>
                </div>
            </div>
        </section>
            ...
            <div class="container pt-5">
                <div class="d-flex flex-md-row flex-column justify-content-center pt-5">
                    <div class="justify-content-left col-md-4 ml-md-n5 mr-md-5" id="alc"
                        uk-scrollspy="cls: uk-animation-slide-right; repeat: false">
                        <img src="https://res.cloudinary.com/billmal/image/upload/v1594983024/Looking_through_1_fdab5r.png" alt="guy looking through binoculars"
                            id="pos-img">
                    </div>
                    <div class="col-md-8 d-flex flex-column align-self-center ml-md-5 pb-md-5"
                        ...
                        <form method="post" action="RegisterServlet" name="myForm"
                            ...
                            <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"
                                placeholder="Email" class="bg-white py-3 pl-3 mr-2" required="must be in the format user@email.com">
